...
const ANALYZE_CACHE_VERSION = "v28"; // bump when prompt structure changes
...
3. Spark / Edge (0-25) — distinctiveness OR insight. A turn you didn't expect, a metaphor that opens a door, voice that won't borrow received language — OR precise observation, sharp argument, emotional accuracy that resists received language. Novelty alone is not quality. SOLID-BAND TEST: one genuine surprise qualifies — a paradox, sardonic turn, inversion, unexpected metaphor, OR an observation that resists received language. Does NOT require canonical-level transformation.
   SARDONIC GATE (apply BEFORE flagging anything under Spark): decide first whether the register is dry, sardonic, wry, or ironic. If yes: (a) treat cliché, forced-feeling rhyme, flat diction, deadpan plainness, and sentimental-sounding closings as candidate Spark GAINS — the trite phrase or banged rhyme deployed knowingly IS the joke, credit it; (b) MOCK-UNIVERSAL CLAIMS used dryly ("fat with money — can't be bad", "turns people mean", "the working man") count as Spark GAINS too — sardonic poems USE fake-aphorism as the move, so the SINCERE-DIRECTNESS GATE's universal-claim disqualifier is SUSPENDED when sardonic register is confirmed. Don't dock these as "moralizing" — sardonic mock-aphorism IS the craft. Such moves also never count against Craft. Run this gate before docking; the UNLESS clauses in LOCAL ANALYSIS GUIDANCE are subordinate to it, not vice versa.
   SINCERE-DIRECTNESS GATE (parallel to SARDONIC): DISQUALIFIED if the poem asserts a UNIVERSAL CLAIM about how people in general live, conform, crave, or behave — that is sermonic. Collective pronouns ("we", "us", "our") are NOT inherently disqualifying — they're fine when referring to a specific named pair, family, or witnessed group ("we sat by the grave", "us at the table"). The disqualifier is the universality, not the pronoun. Fires when the speaker addresses a PARTICULAR OTHER (a specific "you") or witnesses a SPECIFIC MOMENT. When it fires, plain sincere diction earns Spark and Echo through emotional accuracy (devotional, folk, lullaby, witness register).
...
MATCHING DISCIPLINE (read AFTER writing strengths, BEFORE matched_profile — this is why matched_profile now appears AFTER strengths in the JSON): choose matched_profile by what your strengths section actually NAMED, not by the poem's apparent ambition, urgency, or voice. Each profile requires SPECIFIC EVIDENCE in strengths:
  ...
  - A (weak-across) — match A when your strengths section is sparse, vague, or dominated by THESES per STRENGTH-NAMING DISCIPLINE (e.g. "honest voice," "moral center," "urgent message," "important paradox" applied to argument-statements). MECHANICAL CHECK (non-negotiable): if 2+ of your strengths are quoted lines that are themselves theses asserting how people in general live ("we erase ourselves," "killing our souls," "we crave the reflection"), matched_profile MUST be A regardless of how arresting the quotes feel — NO exceptions for "compact closing turn" or "stark distillation" wording in strength_pillars. The SARDONIC GATE explicitly does NOT trigger this mechanical check because sardonic poems use mock-universal claims as the joke, not as sincere theses. Sermonic register at the strength level IS the A profile, regardless of how earnest or rhymed the poem feels. This is load-bearing — most over-matches happen here.
...
STRENGTH-NAMING DISCIPLINE (read BEFORE writing strengths[]): distinguish DELIVERY from THESIS. A strength is a specific line, image, turn, or voice move that resists received language. A thesis ("we conform," "we erase ourselves to fit," "we crave reflection," "love hurts," "the system is rigged") presented in rhyme is NOT a strength — it is a widely-held diagnosis the reader could derive without the poem. This applies to QUOTED LINES too: the test is whether the quoted LINE ITSELF resists received language. Diagnosis-lines fail even when quoted ("we erase ourselves" stays a diagnosis); specific-moment lines pass ("she stopped being herself", "the kitchen light went out"). Quoting doesn't transform a diagnosis into a fresh move. Words like "honest voice," "urgent message," "moral center," "important paradox," "sharp moral point" describe TOPIC, not craft. If the candidate strength is the message rather than the move that delivers it, OMIT it. 1-3 items total; one real strength beats three theses.
